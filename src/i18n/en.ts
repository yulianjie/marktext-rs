...
export default {
  ...
  prefs: {
    ...
    cloud: {
      intro: 'Keep editing local files while MarkText synchronizes them through a self-hosted service, Git, WebDAV, or a storage plugin.',
      empty: 'No cloud storage connection has been configured.',
      add: 'Add connection',
